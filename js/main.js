(function (window, factory) {
    ...
    (function (jStat, Math) {
        ...
        (function (list) {
            ...
            'binomial negbin hypgeom poisson triangular tukey arcsine').split(' '));
    ...
    jStat.models = (function () {
        function sub_regress(exog) {
            ...
            var modelList = jStat.arange(var_count).map(function (endog_index) {
                var exog_index = jStat.arange(var_count).filter(function (i) { return i !== endog_index; });
                return ols(jStat.col(exog, endog_index).map(function (x) { return x[0]; }), jStat.col(exog, exog_index));
            });
            return modelList;
        }
        ...
        function ols(endog, exog) {
            ...
            var predict = jStat.multiply(exog, coef.map(function (x) { return [x]; }))
    ...
    jStat.extend({
        ...
        regresst: function regresst(jMatX, jMatY, sides) {
            ...
            compile.anova.pvalue =
                jStat.anovaftest(compile.anova.fratio, jMatX[0].length - 1, jMatY.length - (jMatX[0].length - 1) - 1);
